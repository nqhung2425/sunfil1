	...
	return (
		<div className="flex-1 flex gap-2 justify-between">
			...
			<div className="flex gap-[1.5rem]">
				<HeaderToolItem
					isSemibold
					imgSrc={<img src="/icons/Clock.svg" className="w-5 h-5" />}
					text={t('header.benefits.support')}
				/>
				<HeaderToolItem
					isSemibold
					imgSrc={<img src="/icons/Hand Money.svg" className="w-5 h-5" />}
					text={t('header.benefits.freeShipping')}
				/>
				<HeaderToolItem
					isSemibold
					imgSrc={<img src="/icons/truck_fill.svg" className="w-5 h-5" />}
					text={t('header.benefits.fastDelivery')}
				/>
				<HeaderToolItem
					isSemibold
					imgSrc={<img src="/icons/Refresh Circle.svg" className="w-5 h-5" />}
